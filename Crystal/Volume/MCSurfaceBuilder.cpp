...
void MCSurfaceBuilder::build(const Volume<float>& volume, const double isoLevel)
{
...
/*
void MCSurfaceBuilder::build(const SparseVolume<float>& volume, const float isoLevel)
{
...
*/
int MCSurfaceBuilder::march(const MCCell& cell, const double isolevel)
{
